...
export const FALLBACK_SUBCATEGORIES: Record<string, SubcategoryItem[]> = {
  Electronics: [
    ...
    { name: "Cables & Chargers", image: "https://images.unsplash.com/photo-1657252084959-a0c1a26744df?w=400" },
    { name: "Webcams", image: "https://images.unsplash.com/photo-1625948515291-69613efd103f?w=400" },
  ],
  Fashion: [
